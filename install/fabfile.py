...
git_repo = 'git@github.com:mgrundy/mcc'
env.hosts = ['mongo-cc.hostingcompany.fakename']

base_dir = '/opt/10gen/mongo-cc-ui'
current_link = os.path.join(base_dir, 'current')
releases_dir = os.path.join(base_dir, 'releases')
init_path = os.path.join(current_link, 'init/mongo-cc')
...
def deploy():
    ...
    # restart the service
    sudo('/etc/init.d/mongo-cc restart')
